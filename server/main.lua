                ...
                if Player ~= nil then
                    ...
                    if vehicleCount >= 1 then
                        ...
                        if Config.Notify == 'QBCore' then
                            TriggerClientEvent('QBCore:Notify', Player.PlayerData.source, Lang:t('notify_QbCore.message', {value = tax, value2 = NotifyCount}), "success", 10000) -- tax, vehicleCount
                ...
                for k, playerid in pairs(GetPlayers()) do
                    ...
                    if xPlayer ~= nil then
                        ...
                        if vehicleCount >= 1 then
                            ...
                            if Config.Notify == 'Ingame' then
                                TriggerClientEvent('taxes:notify', xPlayer.source, tax, NotifyCount)
                            elseif Config.Notify == 'ESX' then
                                xPlayer.showNotification(_U('message_Ingame', tax, NotifyCount))
                            end
                        end
                    end
                end
